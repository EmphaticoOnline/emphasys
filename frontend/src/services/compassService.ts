...
export type RevisionFrente={frente_id:number;nombre:string;intencion_semanal_id:number|null;prioridad_snapshot:IntencionPrioridad|null;horas_objetivo_snapshot:number|null;expectativa_atencion_snapshot:ExpectativaAtencion|null;horas_planificadas:number;horas_efectivas:number;congruencia_sugerida:Congruencia|null;congruencia_confirmada:Congruencia|null;que_ocurrio:string|null;que_bloqueo:string|null;que_aprendi:string|null;que_cambiare:string|null};
